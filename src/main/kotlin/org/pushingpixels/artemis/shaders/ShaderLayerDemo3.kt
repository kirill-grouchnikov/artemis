...
fun main() = auroraApplication {
    ...
    val blurRuntimeEffect = RuntimeEffect.makeForShader(blurSksl)
    val blurShaderBuilder = RuntimeShaderBuilder(blurRuntimeEffect)
    blurShaderBuilder.uniform("cutoff", 100.0f)
